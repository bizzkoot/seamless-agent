...
`;
  ...
  var md = new lib_default({
    ...
    highlight: function(str, lang) {
      if (lang && core_default.getLanguage(lang)) {
        try {
          return core_default.highlight(str, { language: lang, ignoreIllegals: true }).value;
        } catch (_) {
        }
      }
      try {
        return core_default.highlightAuto(str).value;
      } catch (_) {
      }
      return "";
    }
  ...
  (function() {
    ...
    function showQuestion(question, title) {
      if (questionTitle) {
